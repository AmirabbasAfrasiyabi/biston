"""
Django settings for biston project.
...
SECRET_KEY = 'django-insecure-s4!u#h%6#_1d7c)%__=%o%lr!_2u6gt6v#_!dt4-0=+vk=s*y0'
...
WSGI_APPLICATION = 'biston.wsgi.application'
